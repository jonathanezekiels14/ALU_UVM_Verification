...
module alu_assertions (
	...
	// x/z propagation checks on control signals
	...
	// comparator flags mutual exclusivity check
	...
	cover_logical_mode: cover property (disable iff (RST) (MODE == 0 && CE));
	cover_arithmetic_mode: cover property (disable iff (RST) (MODE == 1 && CE));
